...
def clean_company_name(line: str) -> str:
    """Extract a company name from its structured document line."""
...
def postprocess_entity(
    ...
    """Convert the model output into a project-friendly entity."""
    ...
    # Use the original OCR text instead of the tokenizer's WordPiece text.
